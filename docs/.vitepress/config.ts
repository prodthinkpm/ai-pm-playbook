      ...
      '/guide/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '偏好数据、DPO 和 RLHF', link: '/guide/12-llm-engineering/08-preference-data-dpo-rlhf' },
            { text: '合成数据和数据清洗', link: '/guide/12-llm-engineering/09-synthetic-data-data-curation' },
            { text: 'Fine-tuning 基础', link: '/guide/12-llm-engineering/10-fine-tuning-basics' },
            { text: 'LoRA 和 Adapter Tuning', link: '/guide/12-llm-engineering/11-lora-adapter-tuning' },
            { text: 'QLoRA 和量化', link: '/guide/12-llm-engineering/12-qlora-quantization' },
            { text: 'Checkpoint、Adapter 和 GGUF', link: '/guide/12-llm-engineering/13-checkpoint-adapter-gguf' },
            { text: 'RAG 基础', link: '/guide/12-llm-engineering/14-rag-basics' },
            { text: 'Tool Calling 和 Agent', link: '/guide/12-llm-engineering/15-tool-calling-agent' },
            { text: '推理优化和模型服务', link: '/guide/12-llm-engineering/16-inference-optimization-serving' },
            { text: '本地 AI 生态', link: '/guide/12-llm-engineering/17-local-ai-ecosystem' },
            { text: '评估、成本和产品落地', link: '/guide/12-llm-engineering/18-evaluation-costs-product' },
          ],
        },
      ],
    },
